...
namespace Ungureanu_Alin_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ungureanu_Alin_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ungureanu_Alin_Lab8Context context,
